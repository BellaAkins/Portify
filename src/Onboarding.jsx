      ...
      {step < 4 && (
        <div className="mt-12 flex justify-center">
          <button
            ...
            onClick={goNext}
            className="px-25 py-3 border border-[#1ABCFE] rounded-xl text-[#1ABCFE] text-[1.2rem] font-semibold hover:bg-[#1ABCFE] hover:text-white transition  active:bg-[#1ABCFE] active:text-white
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto mb-10">
        ...
        >
          <h2 className="text-[1.5rem] lg:text-[2rem]  py-8 font-semibold mb-2 text-[#1C3B5E]">
      ...
      <div className="flex justify-center mt-6">
        <button
          onClick={handleStart}
          className="px-15 py-3 border border-[#1ABCFE]  text-[#1ABCFE] text-[1rem] rounded-xl font-semibold hover:bg-[#1ABCFE] hover:text-white transition   active:bg-[#1ABCFE] active:text-white"
        >
          Start Building
        </button>
      </div>
